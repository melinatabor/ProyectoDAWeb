...
namespace DAL
{
    public class Acceso
    {
        private static SqlConnection _connection = new SqlConnection("Data Source=JUANIGNACIO1D35\\SQLEXPRESS;Initial Catalog=DistHaras;Integrated Security=True;TrustServerCertificate=True;");
